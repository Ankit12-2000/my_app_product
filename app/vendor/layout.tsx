...
import { SidebarProvider } from "@/components/vendor/SidebarContext";
import { MobileMenuButton, SidebarDrawer } from "@/components/vendor/MobileSidebar";
    ...
    <SidebarProvider>
      <div className="min-h-screen bg-clay-50">
        ...
        <div className="mx-auto grid max-w-7xl gap-6 px-4 py-6 sm:px-6 lg:grid-cols-[260px_1fr]">
          ...
          <SidebarDrawer shopName={shop?.name ?? ""} />
