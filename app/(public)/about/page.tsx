...
export default function AboutPage() {
  return (
    <div className="mx-auto max-w-3xl px-4 py-10">
      <h1 className="text-3xl font-bold">About Murti Market Online</h1>
      <p className="mt-4 text-lg text-clay-700">
        Murti Market Online is Jaipur&apos;s trusted marketplace for premium marble statues and handcrafted
