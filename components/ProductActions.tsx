...
export function ProductActions({
  ...
  return (
    <div className="space-y-2.5">
      <a
        href="#inquiry"
        className="flex w-full items-center justify-center gap-2.5 rounded-xl bg-saffron-600 px-4 py-3.5 text-sm font-bold text-white shadow-sm transition hover:bg-saffron-700 hover:shadow"
      >
      ...
      <button
        onClick={handleShare}
        className="flex w-full items-center justify-center gap-2 rounded-xl border-2 border-clay-200 bg-white px-4 py-3 text-sm font-bold text-clay-800 transition hover:border-clay-300 hover:bg-clay-50"
      >
        <svg className="h-4.5 w-4.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
